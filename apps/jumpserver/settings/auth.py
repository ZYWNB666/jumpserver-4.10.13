...
FEISHU_ORG_IDS = CONFIG.FEISHU_ORG_IDS
...
AUTHENTICATION_BACKENDS = [
    ...
    AUTH_BACKEND_OAUTH2,
    # 扫码模式
    AUTH_BACKEND_WECOM, AUTH_BACKEND_DINGTALK, AUTH_BACKEND_FEISHU, AUTH_BACKEND_FEISHU_SSO, AUTH_BACKEND_LARK, AUTH_BACKEND_SLACK,
    # Token模式
...
AUTHENTICATION_BACKENDS_THIRD_PARTY = [
    ...
    AUTH_BACKEND_FEISHU_SSO, AUTH_BACKEND_LARK, AUTH_BACKEND_SLACK,
]
